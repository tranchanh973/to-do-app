...
const AppTable = () => {
    ...
    // Cap nhat localStorage khi danh sach todo thay doi
    useEffect(() => {
    ...
    return (
        <div className="w-[98%] mx-auto p-4 border border-gray-300 rounded-md">
            ...
            <div className="h-[900px] overflow-y-auto space-y-4">
                {todos.map((todo, index) => (
                    <div
                        key={index}
                        className="h-[82px] w-[96.6%] bg-white flex items-center mx-2 my-7 border border-black rounded-md"
                    >
